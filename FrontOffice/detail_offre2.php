...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div >
                <p class="badge btn">CDD</p>
                <h1>Technicien Support</h1>
            
                <p>Dzaoudzi - Hybride - 1 ans </p>
            
                <p><b>Missions</b> : Diagnostiquer les défaillances et proposer des solutions d'amélioration</p>
                <p><b>Profil </b>: Sérieux, bases TCP/IP ; modèle OSI, bienvenues</p>
